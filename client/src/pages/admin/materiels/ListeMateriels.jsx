...
import AddMultipleMateriels from "./AddMultipleMateriels";
...
function ListMateriels() {
  ...
  const [showmultipleajout, setshowmultipleajout] = useState(false);
  ...
  return (
    <Layout>
      <Grid container spacing={3}>
        ...
        <Grid item>
          <ColorButton onClick={() => setshowmultipleajout(true)}>
            Multi-Ajout
          </ColorButton>
        </Grid>
      </Grid>
      ...
      <AddEditSaisieMaterielModal
        ...
        handleClose={handleClose}
      />
      <AddMultipleMateriels
        show={showmultipleajout}
        handleClose={handleClose}
      />
    </Layout>
  );
