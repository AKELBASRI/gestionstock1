...
function AddEditAgentModal({Mle,show,handleClose}) {
    ...
    return (
        ...
        <Modal.Header closeButton>
          ...
          <Modal.Title>{usernormal ? `Modification  de l'utilisateur : ${usernormal.agent_full_name} Matricule : ${usernormal.agent_number}`:'Ajout Utilisateur' }</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          ...
          <Form.Group  >
            ...
            <Form.Control value={normaluser.agent_full_name || '' } onChange={handleChange}   type="text" placeholder="nom" id="agent_full_name" />
            <div className="text-danger">{errors.name}</div>
           {usernormal==undefined &&( 
             <div>
            <Form.Label>Matricule </Form.Label>
            <Form.Control value={normaluser.agent_number || ''} onChange={handleChange}   type="text" placeholder="Matricule" id="agent_number" />
           ...
           */} </div> 
            ...
            <Form.Control value={normaluser.agent_email || '' } onChange={handleChange}   type="Email" placeholder="Email" id="agent_email" />
            ...
            <select value={normaluser.agency_id || ''} id="agency_id" onChange={handleChange} className="form-control" aria-label="Default select example">
