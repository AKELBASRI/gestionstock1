...
function AddEditUserModal({Mle,show,handleClose}) {
    ...
    return (
        ...
        <Modal.Header closeButton>
          ...
          <Modal.Title>{usernormal ? `Modification  de l'utilisateur : ${usernormal.nom} Matricule : ${usernormal.Mle}`:'Ajout Utilisateur' }</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          ...
          <Form.Group  >
            ...
            <Form.Control value={normaluser.nom || '' } onChange={handleChange}   type="text" placeholder="nom" id="nom" />
            <div className="text-danger">{errors.name}</div>
           {usernormal==undefined &&( 
             <div>
            <Form.Label>Matricule </Form.Label>
            <Form.Control value={normaluser.Mle || ''} onChange={handleChange}   type="text" placeholder="Matricule" id="Mle" />
